...
public class Window extends javax.swing.JFrame {
    ...
    /**
     * Returns <code>true</code> if the textArea text isn't contains a Codon
     * character string.
     *
    ...
    private void btnReplicateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReplicateActionPerformed
        if (!textEmpty()) {
            // Shows the replication in the TextArea
    ...
    private void btnTranscribeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTranscribeActionPerformed
        if (!textEmpty()) {
            // Shows the transcription in the TextArea
    ...
    private void typerAreaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_typerAreaKeyTyped
    ...
    }//GEN-LAST:event_typerAreaKeyTyped

    // to prevent to type invalid keys and control the delete of typerArea
    private void typerAreaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_typerAreaKeyPressed
    ...
    }//GEN-LAST:event_typerAreaKeyPressed
    ...
    private void btnTyperStringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTyperStringActionPerformed
    ...
    }//GEN-LAST:event_btnTyperStringActionPerformed

    private void btnCopyStringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCopyStringActionPerformed
        defaultPanel.setVisible(false);
    ...
    }//GEN-LAST:event_btnCopyStringActionPerformed

    private void typerAreaAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_typerAreaAncestorAdded
        typerArea.requestFocus();
    }//GEN-LAST:event_typerAreaAncestorAdded

    private void copyTextFieldAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_copyTextFieldAncestorAdded
        copyTextField.requestFocus();
        textFieldTextErased = false;
    }//GEN-LAST:event_copyTextFieldAncestorAdded

    private void copyTextFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_copyTextFieldKeyTyped
    ...
    }//GEN-LAST:event_copyTextFieldKeyTyped
    ...
    private void setWorkAreaUnabled() {
        copyTextField.setForeground(Color.LIGHT_GRAY);// ksjfl
        copyFailedLabel.setText("Invalid text copied!");
    }
    ...
    private void copyTextFieldMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_copyTextFieldMousePressed
        deleteTextFieldDefaultText();
    }//GEN-LAST:event_copyTextFieldMousePressed
    ...
    private void copyTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_copyTextFieldFocusLost
        if (!copyFailedLabel.getText().trim().isEmpty()) {
            copyFailedLabel.setText("");
        }
    }//GEN-LAST:event_copyTextFieldFocusLost

    private void copyTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_copyTextFieldKeyPressed
        if (evt.getExtendedKeyCode() == KeyEvent.VK_BACK_SPACE) {
    ...
    }//GEN-LAST:event_copyTextFieldKeyPressed
