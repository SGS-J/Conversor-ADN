...
import conversoradn.excepciones.CaracterAminoAcidoInvalido;
import conversoradn.logic.mainlogic.caseForms.CaseForm;
    ...
    public static AminoAcid getAminoAcidWithACodon(Codon codon) {
        try {
            if (codon.toString().contains("T")) {
                throw new CaracterAminoAcidoInvalido("Error in the getter...");
            }
            ...
            return acidToReturn;
        } catch (CaracterAminoAcidoInvalido e) {
            return null;
        }
    }
